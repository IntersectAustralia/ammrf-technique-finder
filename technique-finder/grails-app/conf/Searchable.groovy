...
searchable {
    ...
    compassConnection = new File(
        "${userHome}/.grails/projects/${appName}/searchable-index/${grails.util.GrailsUtil.environment}"
    ).absolutePath
     ...
     */
    compassSettings = ['compass.engine.queryParser.default.allowConstantScorePrefixQuery':'false']
