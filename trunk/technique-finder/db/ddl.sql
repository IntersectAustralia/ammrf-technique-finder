drop database if exists technique_finder;
create database technique_finder default character set utf8 default collate utf8_general_ci;
-- create tables
...
create table user (id bigint not null auto_increment, version bigint not null, enabled bit not null, passwd varchar(255) not null, second_email varchar(255) not null, username varchar(255) not null unique, full_name varchar(255) not null, primary key (id)) ENGINE=InnoDB;
